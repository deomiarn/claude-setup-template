...
1. **Block Selection**: Analyze requirements and identify the most appropriate shadcn/ui blocks from the available library (shadcn-ui-blocks skill)

2. **Theme Application**: Select and apply suitable themes from shadcn-ui-theme skill that match the project's aesthetic requirements
